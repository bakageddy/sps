...
CREATE TABLE IF NOT EXISTS running_query_pgsql (
	timestamp				UBIGINT NOT NULL,
	pid						UBIGINT NOT NULL,
	query_time_ms			UBIGINT NOT NULL,
	txn_time_ms				UBIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS running_query_mssql (
...
CREATE TABLE IF NOT EXISTS running_query_spwho2 (
	spid					UBIGINT NOT NULL,
	status					STRING NOT NULL,
	login					STRING NOT NULL,
	hostname				STRING NOT NULL,
	blocked_by				UBIGINT NULL,
	db_name					STRING NOT NULL,
	command					STRING NOT NULL,
	cpu_time				UBIGINT NOT NULL,
	disk_io					UBIGINT NOT NULL,
	last_batch				STRING NOT NULL,
	program_name			STRING NOT NULL,
