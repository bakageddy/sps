 ...
 */
export function stuckqueryMssqlBlockingSnapshots(): Promise<
	BlockingSnapshot[]
> {
 ...
 */
export function stuckqueryMssqlQueries(
	timestamp: number,
): Promise<MssqlQuery[]> {
	return invoke("stuckquery_mssql_queries", { timestamp });
}
export function stuckqueryPgsqlQueries(
	timestamp: number,
): Promise<PgsqlQuery[]> {
 ...
 */
export function stuckqueryMssqlBlocking(
	timestamp: number,
